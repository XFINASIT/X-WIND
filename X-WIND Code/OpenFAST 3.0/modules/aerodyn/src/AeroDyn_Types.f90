...
! =========  AD_InputFile  =======
  TYPE, PUBLIC :: AD_InputFile
    ...
    LOGICAL  :: ShenTipLoss      !< Use the Shen's tip correction model? [unused when WakeMod=0] [flag]
...
ENDIF
    ...
    DstInputFileData%ShenTipLoss = SrcInputFileData%ShenTipLoss
...
ENDIF
 ...
 ! buffers to store subtypes, if any
  ...
  END IF
      ...
      Int_BufSz  = Int_BufSz  + 1  ! ShenTipLoss
  ...
  END IF
    ...
    Int_Xferred = Int_Xferred + 1
    IntKiBuf(Int_Xferred) = TRANSFER(InData%ShenTipLoss, IntKiBuf(1))
    Int_Xferred = Int_Xferred + 1
 ...
 ! buffers to store meshes, if any
  ...
  END IF
    ...
    Int_Xferred = Int_Xferred + 1
    OutData%ShenTipLoss = TRANSFER(IntKiBuf(Int_Xferred), OutData%ShenTipLoss)
    Int_Xferred = Int_Xferred + 1
