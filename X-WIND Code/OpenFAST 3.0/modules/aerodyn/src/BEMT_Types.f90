...
! =========  BEMT_InitInputType  =======
  TYPE, PUBLIC :: BEMT_InitInputType
    ...
    LOGICAL  :: useShenTipLoss      !< Use the Shen's tip correction model?  [flag] [-]
...
ENDIF
    ...
    DstInitInputData%useShenTipLoss = SrcInitInputData%useShenTipLoss
...
ENDIF
 ...
 ! buffers to store subtypes, if any
  ...
  END IF
      ...
      Int_BufSz  = Int_BufSz  + 1  ! useShenTipLoss
  ...
  END IF
    ...
    Int_Xferred = Int_Xferred + 1
    IntKiBuf(Int_Xferred) = TRANSFER(InData%useShenTipLoss, IntKiBuf(1))
    Int_Xferred = Int_Xferred + 1
 ...
 ! buffers to store meshes, if any
  ...
  END IF
    ...
    Int_Xferred = Int_Xferred + 1
    OutData%useShenTipLoss = TRANSFER(IntKiBuf(Int_Xferred), OutData%useShenTipLoss)
    Int_Xferred = Int_Xferred + 1
...
ENDIF
    ...
    DstParamData%useShenTipLoss = SrcParamData%useShenTipLoss
