...
!----------------------------------------------------------------------------
    ...
    DO I=1,IMX                                                         
	    ...
	    IF(XNQ.LE.EPPM)THEN                                                         !
            ...
            WRITE(1000,*) 
            WRITE(1000,'(A,I7,A)') 'Error: area of panel ',i,' is too small'
            WRITE(1000,'(A,E14.7)') '       - Area = ',0.5*XNQ
            WRITE(1000,'(A,E14.7)') '       - XG   = ',0.25*(X(M1(I))+X(M2(I))+X(M3(I))+X(M4(I)))
            WRITE(1000,'(A,E14.7)') '       - YG   = ',0.25*(Y(M1(I))+Y(M2(I))+Y(M3(I))+Y(M4(I)))
            WRITE(1000,'(A,E14.7)') '       - ZG   = ',0.25*(Z(M1(I))+Z(M2(I))+Z(M3(I))+Z(M4(I)))
            STOP          
        ENDIF
        XN(I)=XNX/XNQ                                                             
        YN(I)=XNY/XNQ                                                             
