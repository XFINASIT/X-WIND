...
!       Read surfacic mesh
        ...
        DO c=1,Nbodies
            ...
            IF ((c.GT.1).AND.(N.NE.Mesh%Isym)) THEN
                ...
                WRITE(1000,*) ' Error: there is an inconsistency in the mesh files regarding the xOz symmetries' 
                STOP     
            ELSE
                Mesh%Isym=N
            END IF          
...
!           Surface of panel, centre and normal vector
            ...
            IF (Mesh%A(i).LT.1.0E-07) THEN
                ...
                WRITE(1000,'(A,I6,A,E14.7)') 'Error: surface of panel ',i,' is too small (',Mesh%A(i),')'
                STOP
            END IF 
            DO j=1,3
