...
!   Locals
    ...
    OPEN(UNIT=1000,FILE='screenjob_postprocess.dat',STATUS='UNKNOWN')
!
!   --- Initialisation -------------------------------------------------------------------------------------------------------------------------------------------------------------------
!     
    PI=4.*ATAN(1.)
...
!   Read results
    CALL ReadTResults(Results,ID%ID(1:ID%lID)//'/results/Forces.dat',ID%ID(1:ID%lID)//'/results/Forces_PANNEL.dat',ID%ID(1:ID%lID)//'/results/index.dat',ID%ID(1:ID%lID)//'/results/FKForce.tec',ID%ID(1:ID%lID)//'/results/FKForce_PANNEL.tec')
