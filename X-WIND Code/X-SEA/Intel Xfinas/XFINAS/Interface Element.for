C=====================================================================
      ...
      SUBROUTINE SOLIDINF(PROPM,PROPG,NODEX,WA,S,COORD,EDIS,EDISI,RE,MWG
     +				   ,FIN)
...
C
      ...
      DIMENSION EDIS(*),EDISI(*),RE(*),COORDO(3,NNO)
 
	DIMENSION SK(24,24)

	DIMENSION FIN(NEF)

	DIMENSION TRFNN(3,3),H(4),PR(4),PS(4),SHAP(3,24),COVR(3),COVS(3)
	DIMENSION VR(3),VS(3),VT(3),RV(3),SV(3),BMATX(3,24)
	DIMENSION STRESS(3),STRAIN(3),DEP(3,3)
...
C	IF(XYZ1.LT.XYZ2.AND.XYZ1.LT.XYZ3) NMX = 1
C	IF(XYZ2.LT.XYZ1.AND.XYZ2.LT.XYZ3) NMX = 2
C	IF(XYZ3.LT.XYZ1.AND.XYZ3.LT.XYZ2) NMX = 3
	...
	WRITE(*,*) 'Pleas Check in the Interface Element'
	STOP
	ENDIF
	...
	UL1 = UL1 + SHAP(1,I)*EDIS(I)
	UM1 = UM1 + SHAP(2,I)*EDIS(I)
	UN1 = UN1 + SHAP(3,I)*EDIS(I)
	ENDDO
	...
	CALL BOND3D(WA(1,IPT),WA(4,IPT),WA(7,IPT),
	1			 STRESS,STRAIN,DEP,PROPM,MTMOD)
