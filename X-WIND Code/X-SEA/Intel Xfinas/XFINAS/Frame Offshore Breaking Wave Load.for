C	=======================================================================
C	=======================================================================
      SUBROUTINE FRAMFOC_OFFSHORE_BREAKING (LM,XYZ,IGSET,PROPG,MTSET,PROPM,IGIDM,
	1				    MLOAD,LRPIN,IHSET)
...
C     FOR OFFSHORE LOAD -- PRAMIN 
	...
	PI = 3.141592654
      ...
      IF (KSPEC.NE.1)THEN      ! OFFSHORE LOAD
      NOFFL    = MLOAD(1)
      NMARINE  = MLOAD(3)
      ELSEIF (KSPEC.EQ.1)THEN  ! SPECTRAL LOAD
      NRES     = MLOAD(1)
      NMARINE  = MLOAD(3)
      ENDIF
...
C     WATER SURFACE PROFILE MIN
      ...
      YLMIN = (WDEPTH + WNU) - WVHIGHT + SEABED
      ENDIF
...
C     ==================================================   
	...
	ALLOCATE(RVAL(25,NRES),IVAL(20,NRES))
